...
namespace WebOS.Migrations
{
    ...
    [Migration("20240125000730_edit-rank.cs")]
    partial class editrankcs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebOS.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOS.Models.DepartmentRank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AcademicReputation")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EmployerReputation")
                        .HasColumnType("int");

                    b.Property<int>("InternationalStudentRatio")
                        .HasColumnType("int");
                    ...
                    b.ToTable("DepartmentRank");
                });

            modelBuilder.Entity("WebOS.Models.Faculty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOS.Models.University", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOS.Models.Upload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FolderDestination")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOS.Models.Department", b =>
                {
                    ...
                    b.HasOne("WebOS.Models.Faculty", "Faculty")
                        .WithMany()
            ...
            modelBuilder.Entity("WebOS.Models.DepartmentRank", b =>
                {
                    b.HasOne("WebOS.Models.Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("WebOS.Models.Faculty", b =>
                {
                    ...
                    b.HasOne("WebOS.Models.University", "University")
                        .WithMany()
